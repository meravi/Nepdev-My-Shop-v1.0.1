		...
		<div class="header-two"><!-- header-two -->
			<div class="container">
				<div class="header-logo">
					<h1><a href="index.html"><span>L</span>okanthali <i>Store</i></a></h1>
		...
		<div class="container"> 
			<div class="welcome-info">
				<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
					...
					<h3 class="w3ls-title">Featured Product har</h3>
									...
									<div class="item">
										<div class="glry-w3agile-grids agileits"> 
											...
											<div class="view-caption agileits-w3layouts">           
												<h4><a href="products.html"><?php echo $NepdevFrontFetch['GuitarName']; ?> </a></h4>
												<p>Lorem ipsum dolor sit amet consectetur</p>
												<h5><?php echo "Rs".$NepdevFrontFetch['GuitarPrice']; ?></h5> 
												<form method="post">
													<input type="hidden" name="cmd" value="_cart" />
										...
										<div class="glry-w3agile-grids agileits"> 
											...
											<div class="view-caption agileits-w3layouts">           
												...
												<form action="#" method="post">
													...
													<button type="submit" class="w3ls-cart" ><i class="fa fa-cart-plus" aria-hidden="true"></i><a href=""> Add to cart</a></button>
												</form>
											</div>         
										</div>  
									</div>
										...
										<div class="glry-w3agile-grids agileits"> 
											...
											<div class="view-caption agileits-w3layouts">           
												...
												<form action="#" method="post">
													...
													<button type="submit" class="w3ls-cart"><i class="fa fa-cart-plus" aria-hidden="true"></i><a href="addcart.php"> Add to cart</a></button>
												</form>
											</div>        
										</div> 
									</div>
					...
					<?php } else{ ?>
				<h3>No Any Product To Display</h3>
					<?php } ?>
				</div>  
			</div>  	
		</div>  	
